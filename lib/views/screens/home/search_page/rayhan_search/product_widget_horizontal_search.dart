...
import 'package:rayhan_test/views/screens/market/view_category_details/view_product_screen.dart';
...
class ProductWidgetHorizontalSearch extends StatelessWidget {
  ProductWidgetHorizontalSearch({super.key, required this.product});
