...
class ServiceViewScreen extends StatefulWidget {
  ...
  const ServiceViewScreen({super.key, required this.product});

  @override
  State<ServiceViewScreen> createState() => _ProductDetailsScreenState();
}

class _ProductDetailsScreenState extends State<ServiceViewScreen> {
  int quantity = 1;
  final TextEditingController noteController = TextEditingController();
  ServicesController restaurantController = Get.find<ServicesController>();
  @override
